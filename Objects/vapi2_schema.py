...
class IoTBenchmark(sgqlc.types.Enum):
    ...
    __choices__ = (
        "DataRateComparison",
        "RxDataRateComparison",
        "TxDataRateComparison",
        "TimeInUseComparison",
        "HostsComparison",
        "InternalHostsComparison",
        "ExternalHostsComparison",
        "VisitedHostsThreatComparison",
        "VisitedHostsGeographicComparison",
        "DeviceProtocolsUsedComparison",
    )
...
class AppFilter(sgqlc.types.Input):
    __schema__ = vapi2_schema
    filter_attribute = sgqlc.types.Field(
        sgqlc.types.non_null(ApplicationFilterAttribute), graphql_name="filterAttribute"
    )
    filter_value = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="filterValue"
    )
...
class FieldFilters(sgqlc.types.Input):
    ...
    filters = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(FieldFilter))),
...
class Filter(sgqlc.types.Input):
    __schema__ = vapi2_schema
    filter_attribute = sgqlc.types.Field(
        sgqlc.types.non_null(FilterableAttribute), graphql_name="filterAttribute"
    )
    filter_value = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="filterValue"
    )
...
class AccessPointNeighbor(sgqlc.types.Type):
    __schema__ = vapi2_schema
    ap_mac_addr = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="apMacAddr"
    )
...
class AccessPointRadio(sgqlc.types.Type):
    __schema__ = vapi2_schema
    radio_number = sgqlc.types.Field(
        sgqlc.types.non_null(Int), graphql_name="radioNumber"
    )
    ...
    bssids = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="bssids",
    )
    essids = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="essids",
    )
    ap_radio_status = sgqlc.types.Field(String, graphql_name="apRadioStatus")
    neighbor_list = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(AccessPointNeighbor)),
        graphql_name="neighborList",
    )
    rogue_list = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null("AccessPointRogue")),
        graphql_name="rogueList",
    )
    noise_source_list = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(AccessPointNoiseSource)),
        graphql_name="noiseSourceList",
    )
    associated_client_list = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null("RadioAssociatedClient")),
        graphql_name="associatedClientList",
    )


class AccessPointRogue(sgqlc.types.Type):
    __schema__ = vapi2_schema
    bssid_mac_addr = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="bssidMacAddr"
    )
...
class AttributeChange(sgqlc.types.Type):
    __schema__ = vapi2_schema
    sample_time = sgqlc.types.Field(
        sgqlc.types.non_null(Date), graphql_name="sampleTime"
    )
...
class BaselineStats(sgqlc.types.Type):
    ...
    deviation_info = sgqlc.types.Field(
        sgqlc.types.non_null("DeviationInfo"), graphql_name="deviationInfo"
    )
...
class HasAccessPoint(sgqlc.types.Interface):
    __schema__ = vapi2_schema
    ap_descriptions = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(String)), graphql_name="apDescriptions"
    )


class HasCustomGroup(sgqlc.types.Interface):
    __schema__ = vapi2_schema
    custom_group_names = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="customGroupNames",
    )


class HasLocation(sgqlc.types.Interface):
    __schema__ = vapi2_schema
    location_names = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="locationNames",
    )


class HasNsUser(sgqlc.types.Interface):
    __schema__ = vapi2_schema
    ns_user_names = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="nsUserNames",
    )
...
class IncidentRemediations(sgqlc.types.Type):
    ...
    next_steps = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="nextSteps",
    )
    uuids = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="uuids",
    )
...
class IncidentTopAttribute(sgqlc.types.Type):
    ...
    value = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name="value")
    affected_count = sgqlc.types.Field(
        sgqlc.types.non_null(Int), graphql_name="affectedCount"
    )
    percent_affected = sgqlc.types.Field(
        sgqlc.types.non_null(Float), graphql_name="percentAffected"
    )
...
class IoTBenchmarkComparison(sgqlc.types.Type):
    ...
    you = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(HistogramBucket))
        ),
        graphql_name="you",
    )
    others = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(HistogramBucket))
        ),
        graphql_name="others",
...
class IoTSingleAggStats(sgqlc.types.Type):
    ...
    total_bytes = sgqlc.types.Field(
        sgqlc.types.non_null(Float), graphql_name="totalBytes"
    )
    ...
    device_initiated_connections = sgqlc.types.Field(
        Float, graphql_name="deviceInitiatedConnections"
    )
...
class Location(sgqlc.types.Type):
    ...
    controller_ips = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="controllerIps"
    )
    subnets = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="subnets"
    )
    aps = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="aps"
    )
    ap_regex_value = sgqlc.types.Field(String, graphql_name="apRegexValue")
    router_interface_ids = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)),
        graphql_name="routerInterfaceIds",
    )
...
class NyansaGraphQLQuery(sgqlc.types.Type):
    __schema__ = vapi2_schema
    access_point_list = sgqlc.types.Field(
        sgqlc.types.non_null("AccessPointList"),
        graphql_name="accessPointList",
        args=sgqlc.types.ArgDict(
            (
                ...
                (
                    "page_size",
                    sgqlc.types.Arg(Int, graphql_name="pageSize", default=25),
                ),
                ...
                (
                    "sort_order",
                    sgqlc.types.Arg(
                        SortingOrder, graphql_name="sortOrder", default="DESC"
                    ),
                ),
                (
                    "from_date",
                    sgqlc.types.Arg(Date, graphql_name="fromDate", default=None),
                ),
                (
                    "location_filter",
                    sgqlc.types.Arg(
                        sgqlc.types.list_of(sgqlc.types.non_null(String)),
                        graphql_name="locationFilter",
                        default=None,
                    ),
                ),
                (
                    "filters",
                    sgqlc.types.Arg(FieldFilters, graphql_name="filters", default=None),
                ),
            )
        ),
    )
    device_list = sgqlc.types.Field(
        sgqlc.types.non_null("DeviceList"),
        graphql_name="deviceList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
    ...
    server_list = sgqlc.types.Field(
        sgqlc.types.non_null("ServerList"),
        graphql_name="serverList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
    ...
    controller_list = sgqlc.types.Field(
        sgqlc.types.non_null("ControllerList"),
        graphql_name="controllerList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
    ...
    application_list = sgqlc.types.Field(
        sgqlc.types.non_null("ApplicationList"),
        graphql_name="applicationList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
                ...
                (
                    "agg_window",
                    sgqlc.types.Arg(
                        AggregationWindow, graphql_name="aggWindow", default="last24h"
                    ),
                ),
                (
                    "location_filter",
                ...
                (
                    "app_filter",
                    sgqlc.types.Arg(AppFilter, graphql_name="appFilter", default=None),
                ),
            )
        ),
    )
    omnisearch_list = sgqlc.types.Field(
        sgqlc.types.non_null("NyansaEntityList"),
        graphql_name="omnisearchList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
    ...
    location_list = sgqlc.types.Field(
        sgqlc.types.non_null("LocationList"),
        graphql_name="locationList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "names",
                ...
                (
                    "sort_order",
                    sgqlc.types.Arg(
                        SortingOrder, graphql_name="sortOrder", default="ASC"
                    ),
                ),
            )
        ),
    )
    custom_group_list = sgqlc.types.Field(
        sgqlc.types.non_null("CustomGroupList"),
        graphql_name="customGroupList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "names",
                ...
                (
                    "type_filter",
                    sgqlc.types.Arg(
                        CustomGroupType, graphql_name="typeFilter", default=None
                    ),
                ),
                (
                    "location_filter",
    ...
    incident_list = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null("Incident"))),
        graphql_name="incidentList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
                ...
                (
                    "metric_category",
                    sgqlc.types.Arg(
                        MetricCategory, graphql_name="metricCategory", default=None
                    ),
                ),
                (
                    "from_date",
    ...
    device_problems_list = sgqlc.types.Field(
        sgqlc.types.non_null("DeviceProblemsList"),
        graphql_name="deviceProblemsList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "uuids",
    ...
    affected_client_hours_distribution = sgqlc.types.Field(
        sgqlc.types.non_null("AffectedClientHoursList"),
        graphql_name="affectedClientHoursDistribution",
        args=sgqlc.types.ArgDict(
            (
                (
                    "metric_category",
    ...
    global_advisory_list = sgqlc.types.Field(
        sgqlc.types.non_null("GlobalAdvisoryList"),
        graphql_name="globalAdvisoryList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "sort_by",
    ...
    remediation_list = sgqlc.types.Field(
        sgqlc.types.non_null("RemediationList"),
        graphql_name="remediationList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "metric_category",
    ...
    baseline_stats_list = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(BaselineStats))),
        graphql_name="baselineStatsList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "metric_name",
                    sgqlc.types.Arg(Metric, graphql_name="metricName", default=None),
                ),
                (
                    "metric_id",
                    sgqlc.types.Arg(String, graphql_name="metricId", default=None),
                ),
                (
                    "sort_order",
                    sgqlc.types.Arg(
                ...
                (
                    "usage_level",
                    sgqlc.types.Arg(
                        UsageLevel, graphql_name="usageLevel", default="high"
                    ),
                ),
                (
                    "location_filter",
                    sgqlc.types.Arg(
                        String, graphql_name="locationFilter", default=None
                    ),
                ),
                (
                    "filter",
                    sgqlc.types.Arg(Filter, graphql_name="filter", default=None),
                ),
                (
                    "from_date",
                    sgqlc.types.Arg(Date, graphql_name="fromDate", default=None),
    ...
    usage_history_list = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null("UsageTsSample"))
        ),
        graphql_name="usageHistoryList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "metric_name",
    ...
    annotation_list = sgqlc.types.Field(
        sgqlc.types.non_null("AnnotationList"),
        graphql_name="annotationList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "page_size",
                ...
                (
                    "annotation_group",
                    sgqlc.types.Arg(
                        AnnotationType, graphql_name="annotationGroup", default=None
                    ),
                ),
                (
                    "from_date",
                ...
                (
                    "custom_group_filter",
                    sgqlc.types.Arg(
                        String, graphql_name="customGroupFilter", default=None
                    ),
                ),
                (
                    "filters",
    ...
    iot_outlier_list = sgqlc.types.Field(
        sgqlc.types.non_null("IoTOutlierList"),
        graphql_name="iotOutlierList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "uuids",
    ...
    iot_device_stats_list = sgqlc.types.Field(
        sgqlc.types.non_null("IoTDeviceStatsList"),
        graphql_name="iotDeviceStatsList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "page_size",
    ...
    iot_group_stats_list = sgqlc.types.Field(
        sgqlc.types.non_null("IoTGroupStatsList"),
        graphql_name="iotGroupStatsList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "page_size",
    ...
    iot_single_device_stats = sgqlc.types.Field(
        sgqlc.types.non_null("IoTSingleStats"),
        graphql_name="iotSingleDeviceStats",
        args=sgqlc.types.ArgDict(
            (
                (
                    "uuid",
                ...
                (
                    "agg_field",
                    sgqlc.types.Arg(
                        IoTStatsAggField, graphql_name="aggField", default="host"
                    ),
                ),
                (
                    "slice_by_protocol",
                    sgqlc.types.Arg(
                        Boolean, graphql_name="sliceByProtocol", default=True
                    ),
                ),
                (
                    "sort_by",
                    sgqlc.types.Arg(
                        String, graphql_name="sortBy", default="totalBytes"
                    ),
                ),
                (
                    "sort_order",
    ...
    iot_single_group_stats = sgqlc.types.Field(
        sgqlc.types.non_null("IoTSingleStats"),
        graphql_name="iotSingleGroupStats",
        args=sgqlc.types.ArgDict(
            (
                (
                    "model",
                    sgqlc.types.Arg(
                        sgqlc.types.non_null(String), graphql_name="model", default=None
                    ),
                ),
                (
                    "from_date",
    ...
    iot_benchmark_comparisons = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(IoTBenchmarkComparison))
        ),
        graphql_name="iotBenchmarkComparisons",
        args=sgqlc.types.ArgDict(
            (
                (
                    "model",
                ...
                (
                    "benchmark",
                    sgqlc.types.Arg(
                        IoTBenchmark, graphql_name="benchmark", default=None
                    ),
                ),
            )
        ),
    )
    top_url_list = sgqlc.types.Field(
        sgqlc.types.non_null("TopUrlsList"),
        graphql_name="topUrlList",
        args=sgqlc.types.ArgDict(
            (
                (
                    "from_date",
                ...
                (
                    "is_internal",
                    sgqlc.types.Arg(Boolean, graphql_name="isInternal", default=None),
                ),
                (
                    "location_filter",
                    sgqlc.types.Arg(
...
class RadioAssociatedClient(sgqlc.types.Type):
    ...
    ten_min_byte_count = sgqlc.types.Field(
        sgqlc.types.non_null(Long), graphql_name="tenMinByteCount"
    )
...
class RemediationClientHoursByUuid(sgqlc.types.Type):
    __schema__ = vapi2_schema
    uuid = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name="uuid")
    client_hours = sgqlc.types.Field(
        sgqlc.types.non_null(Long), graphql_name="clientHours"
    )
...
class RemediationDistributions(sgqlc.types.Type):
    ...
    distrib = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(RemediationBucket)),
        graphql_name="distrib",
    )
...
class AccessPoint(sgqlc.types.Type, NyansaEntity, HasLocation, HasVoyanceUrl):
    ...
    ap_group = sgqlc.types.Field(String, graphql_name="apGroup")
    last_updated = sgqlc.types.Field(Date, graphql_name="lastUpdated")
    custom_groups = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="customGroups"
    )
    ...
    created_at = sgqlc.types.Field(Date, graphql_name="createdAt")
    ap_radios = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(AccessPointRadio))
        ),
        graphql_name="apRadios",
    )
    affected_client_hours_distribution = sgqlc.types.Field(
        sgqlc.types.non_null("AffectedClientHoursList"),
        graphql_name="affectedClientHoursDistribution",
    ...
    attribute_changes = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(AttributeChange))
        ),
        graphql_name="attributeChanges",
        args=sgqlc.types.ArgDict(
            (
                (
                    "attribute_names",
...
class AccessPointList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    access_points = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(AccessPoint))),
        graphql_name="accessPoints",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class AffectedClientHours(
    sgqlc.types.Type, HasLocation, HasCustomGroup, HasAccessPoint
):
    __schema__ = vapi2_schema
    ...
    all_radius_server_uuids = sgqlc.types.Field(
        String, graphql_name="allRadiusServerUuids"
    )
    all_router_interface_ids = sgqlc.types.Field(
        String, graphql_name="allRouterInterfaceIds"
    )
    connectivity_arp_vlan_id = sgqlc.types.Field(
        String, graphql_name="connectivity_arpVlanId"
    )
    connectivity_dhcp_server_ip = sgqlc.types.Field(
        String, graphql_name="connectivity_dhcpServerIp"
    )
    connectivity_dns_server_ip = sgqlc.types.Field(
        String, graphql_name="connectivity_dnsServerIp"
    )
    connectivity_radius_essid = sgqlc.types.Field(
        String, graphql_name="connectivity_radiusEssid"
    )
    connectivity_radius_server_ip = sgqlc.types.Field(
        String, graphql_name="connectivity_radiusServerIp"
    )
...
class AffectedClientHoursList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    affected_client_hours = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(AffectedClientHours))
        ),
        graphql_name="affectedClientHours",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class Annotation(sgqlc.types.Type, HasLocation, HasCustomGroup, HasNsUser):
    ...
    metric_categories = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(MetricCategory)),
        graphql_name="metricCategories",
    )
    ...
    performance_change = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(PerformanceChange)),
        graphql_name="performanceChange",
    )
    location_names = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="locationNames",
...
class Application(sgqlc.types.Type, NyansaEntity, HasLocation):
    ...
    rx_bytes = sgqlc.types.Field(Float, graphql_name="rxBytes")
    tx_bytes = sgqlc.types.Field(Float, graphql_name="txBytes")
    top_talkers = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(ApplicationTopTalker))
        ),
        graphql_name="topTalkers",
        args=sgqlc.types.ArgDict(
...
class ApplicationList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    applications = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Application))),
        graphql_name="applications",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class ControllerList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    controllers = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Controller))),
        graphql_name="controllers",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class CustomGroup(sgqlc.types.Type, HasLocation):
    ...
    related_devices = sgqlc.types.Field(
        sgqlc.types.non_null("DeviceList"),
        graphql_name="relatedDevices",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
    ...
    related_access_points = sgqlc.types.Field(
        sgqlc.types.non_null(AccessPointList),
        graphql_name="relatedAccessPoints",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
...
class CustomGroupList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    custom_groups = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(CustomGroup))),
        graphql_name="customGroups",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class Device(sgqlc.types.Type, NyansaEntity, HasLocation, HasVoyanceUrl):
    ...
    controller_ip = sgqlc.types.Field(String, graphql_name="controllerIp")
    device_type_details = sgqlc.types.Field(
        DeviceTypeDetails, graphql_name="deviceTypeDetails"
    )
    ...
    access_point_history = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(RelatedAccessPoints))
        ),
        graphql_name="accessPointHistory",
    )
    radio_tech_type_description = sgqlc.types.Field(
        String, graphql_name="radioTechTypeDescription"
    )
    radio_tech_type_channel_width = sgqlc.types.Field(
        String, graphql_name="radioTechTypeChannelWidth"
    )
    related_attributes = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(RelatedAttributes))
        ),
        graphql_name="relatedAttributes",
        args=sgqlc.types.ArgDict(
...
class DeviceList(sgqlc.types.Type, PaginatedResults):
    ...
    devices = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Device))),
...
class DeviceProblemsList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    device_problems = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(DeviceProblems))),
        graphql_name="deviceProblems",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class GlobalAdvisory(sgqlc.types.Type, HasLocation):
    __schema__ = vapi2_schema
    metric_signature = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="metricSignature"
    )
    ...
    affected_entities = sgqlc.types.Field(
        sgqlc.types.non_null("NyansaEntityList"),
        graphql_name="affectedEntities",
        args=sgqlc.types.ArgDict(
            (
                (
                    "search",
...
class GlobalAdvisoryList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    global_advisories = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(GlobalAdvisory))),
        graphql_name="globalAdvisories",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class Incident(sgqlc.types.Type, HasLocation, HasVoyanceUrl):
    ...
    description = sgqlc.types.Field(String, graphql_name="description")
    metric_description = sgqlc.types.Field(String, graphql_name="metricDescription")
    incident_start_time = sgqlc.types.Field(
        sgqlc.types.non_null(Date), graphql_name="incidentStartTime"
    )
    incident_end_time = sgqlc.types.Field(
        sgqlc.types.non_null(Date), graphql_name="incidentEndTime"
    )
    rank = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name="rank")
    unique_affected_count = sgqlc.types.Field(
        sgqlc.types.non_null(Int), graphql_name="uniqueAffectedCount"
    )
    total_count = sgqlc.types.Field(
        sgqlc.types.non_null(Int), graphql_name="totalCount"
    )
    top_attributes = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(IncidentTopAttribute))
        ),
        graphql_name="topAttributes",
    )
    details = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(IncidentRemediations))
        ),
...
class IoTDeviceStats(sgqlc.types.Type, HasLocation):
    ...
    essids = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="essids"
    )
    vlans = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="vlans"
    )
    suspicious_hosts = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)),
        graphql_name="suspiciousHosts",
    )
    high_risk_hosts = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="highRiskHosts"
    )
    hosts_geo = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="hostsGeo"
    )
    device = sgqlc.types.Field(Device, graphql_name="device")
    is_critical = sgqlc.types.Field(Boolean, graphql_name="isCritical")
    agg_window = sgqlc.types.Field(String, graphql_name="aggWindow")
...
class IoTDeviceStatsList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    iot_device_stats = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(IoTDeviceStats))),
        graphql_name="iotDeviceStats",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class IoTGroupStats(sgqlc.types.Type, HasLocation):
    ...
    protocols = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="protocols",
    )
    is_critical = sgqlc.types.Field(Boolean, graphql_name="isCritical")
    agg_window = sgqlc.types.Field(String, graphql_name="aggWindow")
    location_names = sgqlc.types.Field(
...
class IoTGroupStatsList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    iot_group_stats = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(IoTGroupStats))),
        graphql_name="iotGroupStats",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class IoTOutlier(sgqlc.types.Type, HasLocation):
    ...
    outlier_type = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="outlierType"
    )
    outlier_category = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="outlierCategory"
    )
    outlier_reason = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="outlierReason"
    )
    outlier_value = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="outlierValue"
    )
...
class IoTOutlierList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    io_toutliers = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(IoTOutlier))),
        graphql_name="ioTOutliers",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class IoTSingleStats(sgqlc.types.Type, HasLocation):
    ...
    device_class = sgqlc.types.Field(String, graphql_name="deviceClass")
    model = sgqlc.types.Field(String, graphql_name="model")
    stats = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(IoTSingleAggStats))
        ),
        graphql_name="stats",
    )
    location_names = sgqlc.types.Field(
...
class LocationList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    locations = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Location))),
        graphql_name="locations",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
...
class NumericHistogramBucket(sgqlc.types.Type, HistogramBucket):
    __schema__ = vapi2_schema
    lower_bound = sgqlc.types.Field(
        sgqlc.types.non_null(Float), graphql_name="lowerBound"
    )
    upper_bound = sgqlc.types.Field(
        sgqlc.types.non_null(Float), graphql_name="upperBound"
    )
    label = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name="label")
    count = sgqlc.types.Field(sgqlc.types.non_null(Long), graphql_name="count")
...
class NyansaEntityList(sgqlc.types.Type, PaginatedResults):
    ...
    entities = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(NyansaEntity))),
...
class Remediation(sgqlc.types.Type, HasLocation):
    ...
    uuids = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(String)), graphql_name="uuids"
    )
    client_hours = sgqlc.types.Field(Long, graphql_name="clientHours")
    rf_band = sgqlc.types.Field(Int, graphql_name="rfBand")
    root_cause = sgqlc.types.Field(String, graphql_name="rootCause")
    distributions = sgqlc.types.Field(
        sgqlc.types.list_of(sgqlc.types.non_null(RemediationDistributions)),
        graphql_name="distributions",
    )
    metric_description = sgqlc.types.Field(String, graphql_name="metricDescription")
    remediation_client_hours_by_uuid = sgqlc.types.Field(
        sgqlc.types.non_null(
            sgqlc.types.list_of(sgqlc.types.non_null(RemediationClientHoursByUuid))
        ),
        graphql_name="remediationClientHoursByUuid",
    )
    remediation_uuid_type = sgqlc.types.Field(
        sgqlc.types.non_null(String), graphql_name="remediationUuidType"
    )
    location_names = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="locationNames",
...
class RemediationList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    remediations = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Remediation))),
        graphql_name="remediations",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class Server(sgqlc.types.Type, NyansaEntity, HasLocation, HasVoyanceUrl):
    ...
    hostname = sgqlc.types.Field(String, graphql_name="hostname")
    description = sgqlc.types.Field(String, graphql_name="description")
    server_types = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
        graphql_name="serverTypes",
    )
    last_updated = sgqlc.types.Field(Date, graphql_name="lastUpdated")
    created_at = sgqlc.types.Field(Date, graphql_name="createdAt")
    related_devices = sgqlc.types.Field(
    ...
    ten_min_aggregated_metrics = sgqlc.types.Field(
        EntityAggregatedMetrics, graphql_name="tenMinAggregatedMetrics"
    )
    one_hour_aggregated_metrics = sgqlc.types.Field(
        EntityAggregatedMetrics, graphql_name="oneHourAggregatedMetrics"
    )
    one_day_aggregated_metrics = sgqlc.types.Field(
        EntityAggregatedMetrics, graphql_name="oneDayAggregatedMetrics"
    )
    mac_addr = sgqlc.types.Field(String, graphql_name="macAddr")
    location_names = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(String))),
...
class ServerList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    servers = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(Server))),
        graphql_name="servers",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
...
class TopUrlsList(sgqlc.types.Type, PaginatedResults):
    __schema__ = vapi2_schema
    top_urls = sgqlc.types.Field(
        sgqlc.types.non_null(sgqlc.types.list_of(sgqlc.types.non_null(TopUrls))),
        graphql_name="topUrls",
    )
    page = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="page")
    page_size = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageSize")
    page_count = sgqlc.types.Field(sgqlc.types.non_null(Int), graphql_name="pageCount")
